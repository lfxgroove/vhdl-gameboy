...
\draw [line width=0.625, ->, color=black] (2) to  [in=159, out=20] (3);
\draw [line width=0.625, ->, color=black] (3) to  [in=339, out=200] (2);
...
\node at (50.0pt, -163.125pt) {\textcolor{black}{CPU}};
...
\node at (115.0pt, -250.0pt) {\textcolor{black}{Knappar}};
\node at (51.25pt, -249.375pt) {\textcolor{black}{UART}};
\end{tikzpicture}
